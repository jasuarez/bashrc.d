...
PS1='${chroot_env_names:+(}${chroot_name:+\[\033[01;96m\]${chroot_name}\[\033[00m\]}${env_name:+${chroot_name:+#}\[\033[00;32m\]${env_name}\[\033[00m\]}${chroot_env_names:+)}\[\e[38;5;208m\]\u\[\033[00m\]@\[\e[38;5;208m\]\h\[\033[00m\]:\[\033[31m\]$(parse_vcs)\[\e[38;5;39m\]\w\[\033[00m\]$ '
