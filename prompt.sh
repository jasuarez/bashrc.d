...
if [ -n "$chroot_name" ]; then
        PS1='\[\033[01;37m\]($chroot_name${env_name:+\[\033[00;32m\]#${env_name}})\[\033[01;90m\]\u@\h\[\033[00m\]:\[\033[31m\]$(parse_vcs)\[\033[00;34m\]\w\[\033[00m\]\$ '
else
        PS1='${env_name:+\[\033[00;32m\](#${env_name})}\[\033[01;90m\]\u@\h\[\033[00m\]:\[\033[31m\]$(parse_vcs)\[\033[00;34m\]\w\[\033[00m\]\$ '
fi
